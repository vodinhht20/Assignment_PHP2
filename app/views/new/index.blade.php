        ...
        <div class="row">
            <div class="col-lg-8 col-md-12 col-sm-12 col-12  mb-3">
                <div class="news-primary">
                    <a href="{{BASE_URL}}tin-tuc/bai-viet/{{$postNewPrimary->slug}}">
                        <img src="{{PUBLIC_PATH}}image/{{$postNewPrimary->thumbnail_img}}" class="img-primary" alt="">
                    </a>
                    <div class="short-description">
                        <a href="{{BASE_URL}}tin-tuc/bai-viet/{{$postNewPrimary->slug}}">
                            <h2>{{$postNewPrimary->title}}</h2>
                        </a>
                        <div>{{$postNewPrimary->description_short}}</div>
                    </div>
                    <img src="{{PUBLIC_PATH}}/image/new.gif" class="gif-new" alt="">
                </div>
            </div>
                    ...
                    <div class="row">
                        @foreach ($postListNews as $item)
                           <div class="news-item col-lg-12">
                                <a href="{{BASE_URL}}tin-tuc/bai-viet/{{$item->slug}}"><img src="{{PUBLIC_PATH}}image/{{$item['thumbnail_img']}}" alt=""></a>
                                <div class="short-description">
                                        <a href="{{BASE_URL}}tin-tuc/bai-viet/{{$item->slug}}">
                                            <h3>{{$item['title']}}</h3>
                                        </a>
      ...
      <div class="row">
            @foreach ($postTopicVegetable as $item)
                <div class="col-lg-3 col-md-4 col-sm-6 col-12 news-item">
                        <a href="{{BASE_URL}}tin-tuc/bai-viet/{{$item->slug}}" class="news-item-img">
                            <img src="{{PUBLIC_PATH}}image/{{$item['thumbnail_img']}}">
                        </a>
                        <p class="news-item-date">Thứ Bảy, 10 tháng 7, 2021</p>
                        <h3>
                            <a href="{{BASE_URL}}tin-tuc/bai-viet/{{$item->slug}}" title="Đi chợ online: Xu hướng lên ngôi mùa dịch Covid-19">Đi chợ online: Xu hướng lên ngôi mùa dịch Covid-19</a>
                        </h3>
